...
<html>
  <head>
    ...
    <title>Euroempaste</title>
    <link rel="stylesheet" href="css/estilos.css">
  </head>
  <body>
.    <header id="banner" class="body">
      <!-- Título de la página -->
      <h1><a href="#"><br>EUROEMPASTE CIA. LTDA.<br><strong>Acabados de la construcción</strong></a></h1>
      <!-- Barra de menú -->
      <nav>
        <ul>
    ...
    <aside id="featured" class="body">
      <article>
        <h2>EUROEMPASTE CIA LTDA.</h2>
        <h3><a href="#">Fundada en Quito Ecuador el 04 de febrero del 2014, dedicada a la comercialización   y venta directa  de productos para los acabados de la construcción de alta calidad.
</a></h3>
        <p>Esta empresa en crecimiento con un alto indice de rentabilidad, busca inversionistas para incrementar participación el mercado, generando mayores ingresos para sus socios y futuros inversionistas, que participen activamente en las actividades de la empresa.
.</p>
      </article>
    </aside>
